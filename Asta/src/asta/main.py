...
import uvicorn
import logging
from asta.interfaces.onboarding.profile_generator import ProfileGenerator
from asta.interfaces.native_ui.avatar_websocket import AvatarWebSocketServer
from asta.interfaces.web_ui.dashboard import app as fastapi_app
from asta.core_engine.orchestrator.event_bus import nervous_system

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("Asta_Bootloader")
...
def run_background_event_loop(loop):
    ...
    from asta.actuation_sensory.passive.screen_listener import ScreenListener
...
def main():
    logger.info("=== Asta Boot Sequence Initiated ===")
